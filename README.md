...
**RunPod Explore Pod (Docker 데몬 없음)**
- Podman 사용 (데몬 불필요)
- [QUICKSTART_RUNPOD.md](QUICKSTART_RUNPOD.md) 참고 (5분 빠른 시작)
- [RUNPOD_PODMAN_GUIDE.md](RUNPOD_PODMAN_GUIDE.md) 상세 가이드

**RunPod 일반 Pod (Docker 데몬 있음)**
- [RUNPOD_POD_DEPLOYMENT.md](RUNPOD_POD_DEPLOYMENT.md) 참고
...
### RunPod Explore Pod (Docker 데몬 ❌) - 추천!

**가장 많이 사용되는 런팟 환경**

📘 **빠른 시작:** [QUICKSTART_RUNPOD.md](QUICKSTART_RUNPOD.md) (5분 만에 시작)
📗 **상세 가이드:** [RUNPOD_PODMAN_GUIDE.md](RUNPOD_PODMAN_GUIDE.md)

**특징:**
- ✅ Podman 사용 (Docker 데몬 불필요)
- ✅ 런팟 Explore Pod 환경에서 작동
- ✅ 기존 docker-compose.yml 호환
- ✅ Docker 이미지 방식 유지
...
### RunPod 일반 Pod (Docker 데몬 ✅)

📘 **가이드:** [RUNPOD_POD_DEPLOYMENT.md](RUNPOD_POD_DEPLOYMENT.md)
